...
HumanGeneNames <- unique(c(Hdat1$GeneName.Human,Hdat2$GeneName.Human,Hdat3$GeneName.Human,Hdat4$GeneName.Human,
                           Hdat5$GeneName.Human,Hdat6$GeneName.Human,Hdat7$GeneName.Human,Hdat8$GeneName.Human))
MouseGeneNames <- unique(MDat1$GeneName.Mouse, MDat2$GeneName.Mouse, MDat3$GeneName.Mouse)
write.csv(HumanGeneNames, file = paste0(out.dir,"/GEO_Control_Human_D8_N51714_GeneName_List.csv"), row.names=F)
write.csv(HumanGeneNames, file = paste0(out.dir,"/GEO_Control_Mouse_D3_N40608_GeneName_List.csv"), row.names=F)
