...
## 24966, unique mouse genes is 20564; unique human genes is 19586
colnames(Ensembl_MHhomolog) <- c("MouseGeneName", "HumanGeneName")

write.csv(Ensembl_MHhomolog, file = paste0(Out.dir, "/", Project, "-Ensemble_human_mouse_Homolog.csv"), row.names =F)
...
## common mouse genes number is 16935
...
library(UpSetR)
pdf(paste0(Out.dir, "/", Project, "-Ensembl_MGI_NCBI_human_mouse_upsetR_plot.pdf"))
...
## 27595, 22613 unique mouse; 21407 unique human.
write.csv(Final_MHhomolog, paste0(Out.dir, "/", Project, "-Ensemble_MGI_NCBI_human_mouse_Homolog.csv"), row.names =F)
